...
// UK TV broadcaster per match, sourced from published BBC/ITV schedules (GiveMeSport,
// confirmed June 2026). Knockout-stage broadcasters aren't announced until teams are
// known, so those are intentionally left as "TBC" rather than guessed.
const BROADCASTERS = {
  1: { name: "ITV1", short: "ITV", stream: "ITVX" },
  2: { name: "ITV1", short: "ITV", stream: "ITVX" },
  3: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  4: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  5: { name: "ITV1", short: "ITV", stream: "ITVX" },
  6: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  7: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  8: { name: "ITV1", short: "ITV", stream: "ITVX" },
  9: { name: "ITV1", short: "ITV", stream: "ITVX" },
  10: { name: "ITV1", short: "ITV", stream: "ITVX" },
  11: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  12: { name: "ITV1", short: "ITV", stream: "ITVX" },
  13: { name: "ITV1", short: "ITV", stream: "ITVX" },
  14: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  15: { name: "ITV1", short: "ITV", stream: "ITVX" },
  16: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  17: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  18: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  19: { name: "ITV1", short: "ITV", stream: "ITVX" },
  20: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  21: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  22: { name: "ITV1", short: "ITV", stream: "ITVX" },
  23: { name: "ITV1", short: "ITV", stream: "ITVX" },
  24: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  25: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  26: { name: "ITV1", short: "ITV", stream: "ITVX" },
  27: { name: "ITV1", short: "ITV", stream: "ITVX" },
  28: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  29: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  30: { name: "ITV1", short: "ITV", stream: "ITVX" },
  31: { name: "ITV1", short: "ITV", stream: "ITVX" },
  32: { name: "ITV1", short: "ITV", stream: "ITVX" },
  33: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  34: { name: "ITV1", short: "ITV", stream: "ITVX" },
  35: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  36: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  37: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  38: { name: "ITV1", short: "ITV", stream: "ITVX" },
  39: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  40: { name: "ITV1", short: "ITV", stream: "ITVX" },
  41: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  42: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  43: { name: "ITV1", short: "ITV", stream: "ITVX" },
  44: { name: "ITV1", short: "ITV", stream: "ITVX" },
  45: { name: "ITV1", short: "ITV", stream: "ITVX" },
  46: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  47: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  48: { name: "ITV1", short: "ITV", stream: "ITVX" },
  49: { name: "ITV1", short: "ITV", stream: "ITVX" },
  50: { name: "ITV4", short: "ITV", stream: "ITVX" },
  51: { name: "BBC Two", short: "BBC", stream: "BBC iPlayer" },
  52: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  53: { name: "BBC Two", short: "BBC", stream: "BBC iPlayer" },
  54: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  55: { name: "BBC Two", short: "BBC", stream: "BBC iPlayer" },
  56: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  57: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  58: { name: "BBC Two", short: "BBC", stream: "BBC iPlayer" },
  59: { name: "ITV1", short: "ITV", stream: "ITVX" },
  60: { name: "ITV4", short: "ITV", stream: "ITVX" },
  61: { name: "ITV1", short: "ITV", stream: "ITVX" },
  62: { name: "ITV4", short: "ITV", stream: "ITVX" },
  63: { name: "ITV4", short: "ITV", stream: "ITVX" },
  64: { name: "ITV1", short: "ITV", stream: "ITVX" },
  65: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  66: { name: "BBC Two", short: "BBC", stream: "BBC iPlayer" },
  67: { name: "ITV1", short: "ITV", stream: "ITVX" },
  68: { name: "ITV4", short: "ITV", stream: "ITVX" },
  69: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
  70: { name: "BBC Two", short: "BBC", stream: "BBC iPlayer" },
  71: { name: "BBC Two", short: "BBC", stream: "BBC iPlayer" },
  72: { name: "BBC One", short: "BBC", stream: "BBC iPlayer" },
};

function broadcasterFor(matchId){
  return BROADCASTERS[matchId] || { name: "TBC", short: "TBC", stream: null };
}
